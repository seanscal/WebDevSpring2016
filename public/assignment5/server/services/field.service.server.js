module.exports = function (app, FormModel, FieldModel) {
    ...
    app.get('/api/assignment5/form/:formId/field', findFields);
    app.get('/api/assignment5/form/:formId/field/:fieldId', findField);
    app.delete('/api/assignment5/form/:formId/field/:fieldId', deleteField);
    app.post('/api/assignment5/form/:formId/field', createField);
    app.put('/api/assignment5/form/:formId/field/:fieldId', updateField);
